 ...
 */
    ...
    (() => {
        ...
        function menuInit() {
            if (document.getElementById("hamburger")) document.addEventListener("click", (function(e) {
                if (!window.matchMedia("(max-width:768px)").matches) {
                    if (bodyLockStatus && e.target.closest("#hamburger") && !document.documentElement.classList.contains("menu-open")) document.documentElement.classList.add("menu-open"); else if (bodyLockStatus && !e.target.closest(".sidebar") && document.documentElement.classList.contains("menu-open")) document.documentElement.classList.remove("menu-open");
                } else if (bodyLockStatus && e.target.closest("#hamburger")) {
                    bodyLockToggle();
        ...
        function formFieldsInit(options = {
            ...
            document.body.addEventListener("focusout", (function(e) {
                ...
                if (targetElement.tagName === "INPUT" || targetElement.tagName === "TEXTAREA") {
                    ...
                    if (targetElement.value.length && !targetElement.classList.contains("_form-error")) targetElement.classList.add("_filled"); else targetElement.classList.remove("_filled");
                }
            }));
        ...
        const setSlideText = swiper => {
            const target = document.querySelector(".hero__slider-nav-wrap .hero__slide-text");
            const text = swiper.slides[swiper.activeIndex].querySelector(".hero__slide-text");
        ...
        function initSliders() {
            if (document.querySelector(".our-team__slider")) new swiper_core_Swiper(".our-team__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 2,
            ...
            if (document.querySelector(".projects__tabs")) if (window.innerWidth <= 768 && !tabsSlider) tabsSlider = new swiper_core_Swiper(".projects__tabs", {
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
                spaceBetween: 0,
            ...
            if (document.querySelector(".hero-project__slider")) if (window.innerWidth <= 768) heroProjectSlider = new swiper_core_Swiper(".hero-project__slider", {
            ...
            }); else if (window.innerWidth > 768) heroProjectSlider = new swiper_core_Swiper(".hero-project__slider", {
            ...
            if (document.querySelector(".project-info__slider")) new swiper_core_Swiper(".project-info__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector(".project-layout__slider")) new swiper_core_Swiper(".project-layout__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector(".project-interiors__slider")) new swiper_core_Swiper(".project-interiors__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector(".hero-portfolio__slider")) {
                const portfolioThumbs = new swiper_core_Swiper(".hero-portfolio__thumbs", {
                    spaceBetween: 30,
                    slidesPerView: "auto",
                    freeMode: true
                });
                new swiper_core_Swiper(".hero-portfolio__slider", {
        ...
        window.addEventListener("load", (function() {
            ...
            if (tabs.length) tabs.forEach((tab => {
                ...
                const moveTabs = () => {
                    if (window.innerWidth <= 768) target.appendChild(tab); else if (window.innerWidth > 768) parent.appendChild(tab);
                };
                moveTabs();
            ...
            const onClickHandler = e => {
                if (e.target.closest("[data-tab]")) {
                    const parent = e.target.closest("[data-tab]").closest(".projects__tabs-wrapper");
